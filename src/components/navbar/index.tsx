...
const Navbar = (props: {
  ...
  const [walletAddress] = React.useState("XA3...9L2");
  const [algoBalance] = React.useState("1,250 ALGO");
    ...
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        <div className="flex h-full items-center rounded-full bg-lightPrimary text-navy-700 dark:bg-navy-900 dark:text-white w-full">
          {walletConnected ? (
            <div className="flex items-center justify-between w-full px-3 cursor-pointer" onClick={handleWalletConnect}>
              ...
              <div className="flex items-center gap-2 bg-white dark:bg-navy-800 rounded-full px-3 py-1.5 shadow-sm border border-gray-100 dark:border-navy-700">
                <span className="text-xs font-mono font-medium text-brand-500">{walletAddress}</span>
              </div>
            </div>
          ) : (
            <button
